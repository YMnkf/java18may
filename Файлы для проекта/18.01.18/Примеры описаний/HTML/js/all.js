...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Титульный лист","1. Вводная часть","2. Назначение","3. Функциональные ограничения","4. Описание логики","5. Состав и функции","6. Условия применения","7. Контрольный пример","8. Вызов и загрузка","9. Руководство пользователя","Справочные материалы","4.1. Описание структуры программы и ее основных частей","4.2. Описание функций составных частей и связей между ними","4.3. Описание входных и выходных данных для каждой из составных частей","4.4. Описание логики составных частей","5.1. Модуль расчета ...","5.2. Модуль определения ...","5.3. Модуль построения ...","6.1. Функциональные ограничения","Схема 1","Рисунок 1. Исходная матрица","Рисунок 2. Результирующая матрица"],
    DREX_NODE_LINKS: ["index.htm","vvodnaya_chast.htm","2__naznachenie.htm","3__funktsionalnye_ogranicheniya.htm","4__opisanie_logiki.htm","5__sostav_i_funktsii.htm","6__usloviya_primeneniya.htm","7__kontrolnyj_primer.htm","8__vyzov_i_zagruzka.htm","9__rukovodstvo_polzovatelya.htm","spravochnye_materialy.htm","4_1__opisanie_struktury_programmy_i_ee_osnovnykh_chastej.htm","4_2__opisanie_funktsij_sostavnykh_chastej_i_svyazej_mezhdu_nimi.htm","4_3__opisanie_vkhodnykh_i_vykhodnykh_dannykh_dlya_kazhdoj_iz_sostavnykh_chastej.htm","4_4__opisanie_logiki_sostavnykh_chastej.htm","5_1__modul_rascheta____.htm","5_2__modul_opredeleniya____.htm","5_3__modul_postroeniya____.htm","6_1__funktsionalnye_ogranicheniya.htm","skhema_1.htm","risunok_1__iskhodnaya_matritsa.htm","risunok_2__rezultiruyushchaya_matritsa.htm"],
    DREX_NODE_CHILD_START: [1,11,11,11,11,15,18,19,19,19,19,22,22,22,22,22,22,22,22,22,22,22],
    DREX_NODE_CHILD_END: [11,11,11,11,15,18,19,19,19,19,22,22,22,22,22,22,22,22,22,22,22,22],
    DREX_MENU_TYPE: 1,
