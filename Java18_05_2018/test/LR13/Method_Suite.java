...
public class Method_Suite {
    ...
    @Test
    // аннотация к методу Task9020Test. Маркирует элементы кода (чтобы библиотека junit понимала, что этот метод является тестом
...
// аннотация к методу Task9020assertion1. Маркирует элементы кода (чтобы библиотека junit понимала, что этот метод является тестом
...
// аннотация к методу Task9020assertion1. Маркирует элементы кода (чтобы библиотека junit понимала, что этот метод является тестом
    ...
    @Test
    // аннотация к методу Task3943Test. Маркирует элементы кода (чтобы библиотека junit понимала, что этот метод является тестом
    public void Task3943Test() {
        double result1;
        result1 = Methods.task3943(0, 81); // запись результата вызова метода Methods.task3943 в переменную result1
    ...
    @Test(expected = IllegalArgumentException.class)
// аннотация к методу Task3943assertion1. Маркирует элементы кода (чтобы библиотека junit понимала, что этот метод является тестом
